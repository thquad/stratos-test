...
type PortalProxy interface {
	...
	DoRegisterEndpoint(cnsiName string, apiEndpoint string, skipSSLValidation bool, clientId string, clientSecret string, ssoAllowed bool, subType string, userId string, fetchInfo InfoFunc) (CNSIRecord, error)
